...
export default function PageDepartamentStudents() {
            ...
            <div className="page__wrapper">
                ...
                <main className="page__main">
                    ...
                    <div className="page-one-university__row">
                            <Link to={`/university-${idUniversity}/for-student/`} className="page-one-university__button-prev">Вернуться назад</Link>
                        ...
                        <div className="page-faculties__content">
                            {departaments ? departaments.sort((a, b) => a.short_name > b.short_name ? 1 : -1).map(departament => (
                                <Link key={departament.id} to={`/university-${idUniversity}/for-student/faculty-${idFaculty}/departament-${departament.id}`} className="page-faculties__box" title={departament.full_name}>{departament.short_name}</Link>
                            )) : null}
                        </div>
                        </div>
                    </div>
