...
export default function PageScheduleStudents() {
    ...
    let { idUniversity, idFaculty, idDepartament, idGroup } = useParams();
    ...
    useEffect( () => {
        window.fetch(`https://schedule.dxrk.dev/api/group/${idGroup}/lessons-normal-short-names`)
        .then(res => res.json())
        .then(
            result => {
                setIsLoaded(true);
                        ...
                        <table id="tabledata" ref={ref}>
                            <thead>
                               <tr>
                                ...
                                <th style={{border: '1px solid black'}}>Преподователь</th>
